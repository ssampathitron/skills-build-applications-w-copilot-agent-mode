...
async function seedDatabase() {
    ...
    const [insertedTeams, insertedUsers, insertedActivities, insertedLeaderboard, insertedWorkouts] = await Promise.all([
    ...
    console.log(`Seed complete: ${insertedUsers.length} users, ${insertedTeams.length} teams, ${insertedActivities.length} activities, ${insertedLeaderboard.length} leaderboard entries, ${insertedWorkouts.length} workouts`);
}
seedDatabase()
    .then(async () => {
